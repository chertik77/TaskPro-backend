...
apiRouter.openAPIRegistry.registerComponent('securitySchemes', 'cookieAuth', {
  type: 'apiKey',
  in: 'cookie',
  name: 'taskpro.session_token',
  description:
    'Session cookie issued by better-auth. Sent automatically by the browser with `credentials: include`.'
})
